...
<div class="flex justify-center items-center min-h-[calc(100dvh-100px)]">
  ...
  >
    <div
      class="flex flex-col gap-[60px] md:gap-[80px] bg-[#180F05] py-[60px] md:py-[80px] px-3 rounded-[25px] shadow-[0_15px_50px_#180f05] xl:w-[452px]"
    >
      ...
      <div
        class="flex flex-col gap-[20px] relative z-2 w-full md:w-[318px] xl:w-[281px] mx-auto"
      >
